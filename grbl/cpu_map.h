  ...
  #define PROBE_MASK      (1<<PROBE_BIT)
   ...
   //define speed original values
     ...
     // #define SPINDLE_TCCRA_INIT_MASK   ((1<<WGM20) | (1<<WGM21))  // Configures fast PWM mode.
      ...
      // #define SPINDLE_TCCRB_INIT_MASK   (1<<CS21)               // 1/8 prescaler -> 7.8kHz (Used in v0.9)
      // #define SPINDLE_TCCRB_INIT_MASK   ((1<<CS21) | (1<<CS20)) // 1/32 prescaler -> 1.96kHz
      #define SPINDLE_TCCRB_INIT_MASK      (1 << WGM21) | (0 << CS22) | (1 << CS21) | (1 << CS20)               // 5khz  (synrad laser)
...
//OCR2A = 99; // = 16000000 / (32 * 5000) - 1 (must be <256)
// turn on CTC mode
//TCCR2B |= (1 << WGM21);
// Set CS22, CS21 and CS20 bits for 32 prescaler
//TCCR2B |= (0 << CS22) | (1 << CS21) | (1 << CS20);
// enable timer compare interrupt
//da se to zapsat jako 
//TCCR2B |= (1 << WGM21) | (0 << CS22) | (1 << CS21) | (1 << CS20);
//nepouzito TIMSK2 |= (1 << OCIE2A);
